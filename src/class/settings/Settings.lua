...
---@return {resolution: {w: integer, h: integer, flags: {resizable: boolean, vsync: boolean, minwidth: integer, minheight: integer}}, musicVolume: number, sfxVolume: number} settings
function Settings.createDefaultSettings()
	...
	local resolution = {}
	resolution.w, resolution.h = getClosestResolution(w, h, Settings.SUPPORTED_RESOLUTIONS)
	resolution.flags = data.flags
...
---@return {resolution: {w: integer, h: integer, flags: {resizable: boolean, vsync: boolean, minwidth: integer, minheight: integer}}, musicVolume: number, sfxVolume: number}
...
function Settings:applyAll()
	...
	shove.setWindowMode(resolution.w, resolution.h, resolution.flags)
...
---@param value number|number[] New value being set for the setting
